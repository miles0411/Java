...
public class GPTree implements Comparable {
    ...
    * fitness value to the result of the evaluation. */
    ...
    public double getFitness() { return 
    		fitness; 
    }
    
    /**this is written to clearly hold a 1/fitness as a value for ChooseTreeToProportationalFitness();*/
    public double getadjustedFitness() { 
    	double adjustedfitness = (1/fitness);		
    ...
    * operation and when creating a new generation. */
    ...
    public NodePairPlus randomParentAndChild(Random rand) {
        int clipNumber = (int) (Math.abs(rand.nextInt()) % (mySize()-1) + 2);
        NodePairPlus p;
