...
public class DoubleNode {
	 ...
	 * @param i BigInteger type parameter 
	 */
	public DoubleNode (DoubleNode p, BigInteger i, DoubleNode n){
		PNode = p;
		NNode = n;
		content = i;
	}
	 ...
	 * Precondition: A BigInteger type variable should
	 * be given when this method is called and 
	 * the node is present for setting the value.  
	 * Postcondition: A BigInteger type value will be returned.
	 * Best Case:Big theta(1)
	 * Worst Case: Big theta(1)
	 */
